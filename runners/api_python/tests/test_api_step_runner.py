...
from runners.api_python.executor.api_step_runner import (
    _build_url,
...
from runners.api_python.executor.api_step_runner import _execute_db_assertions, _get_sut_db_url
...
def test_db_assertion_exists():
    ...
    with mock.patch("runners.api_python.executor.api_step_runner.create_engine") as mock_engine:
...
def test_execute_api_test_platform_error():
    ...
    with mock.patch("runners.api_python.executor.api_step_runner.selftest", return_value=(False, "selftest FAIL")):
