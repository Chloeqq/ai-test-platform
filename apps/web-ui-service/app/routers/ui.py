...
def login_page(request: Request, next: str = "/workbench/generate") -> HTMLResponse:
...
def workbench_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "workbench.html", context)
...
def workbench_generate_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "workbench_generate.html", context)
...
def workbench_preview_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "workbench_preview.html", context)
...
def workbench_history_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "workbench_history.html", context)
...
def report_overview_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "report_overview.html", context)
...
def report_failures_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "report_failures.html", context)
...
def report_context_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "report_context.html", context)
...
def report_performance_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "report_performance.html", context)
...
def report_allure_page(request: Request) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "report_allure.html", context)
...
def quality_clusters_page(request: Request) -> HTMLResponse:
    context = _base_context(request, current_key="failure_clusters")
    context.update(
        {
            "page_title": "失败聚类",
    ...
    return templates.TemplateResponse(request, "quality_clusters.html", context)
...
def execution_report_page(request: Request, execution_id: int, db: Session = Depends(get_db)) -> HTMLResponse:
    ...
    return templates.TemplateResponse(request, "report_execution.html", context)
